...
import subrata.project.android.myshoppal.databinding.ActivityAddEditAddressBinding
...
class AddEditAddressActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        window.statusBarColor = ContextCompat.getColor(this@AddEditAddressActivity, R.color.colorPrimaryText)
